...
CPPPATH_PG = ['/usr/local/Cellar/postgresql/9.1.2/include']
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
LIBDIR = '/Users/kbishop/.node_libraries'
LIBPATH_NODE = '/usr/local/lib'
LIBPATH_PG = ['/usr/local/Cellar/postgresql/9.1.2/lib']
LIBPATH_ST = '-L%s'
LIB_PG = ['pq']
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/kbishop/.node_libraries'
